import backgroundImage from '../images/society.jpg';
      ...
      <Center bg='black' h='900px' color='white'>
        ...
        <Box bg='black'  borderRadius='8px' width='30%' ml={30}>
                    <Heading fontFamily='cursive' fontSize='x-large'>
                        <br />We're here to ensure well-lit streets.The platform can offer data analytics and reports to local
governments or other stakeholders, providing valuable insights
on street light maintenance and infrastructure.
                    </Heading>
